...
export function ConsentScreen({
  ...
  appName?: string;
  /**
   * Login name of the already-signed-in account the grant will be issued to
   * (the consent page found a valid session). Shown so the user knows WHO is
   * granting — consent to scopes is consent as an identity. Absent when
   * Allow leads to sign-in instead.
   */
  continueAs?: string;
}) {
